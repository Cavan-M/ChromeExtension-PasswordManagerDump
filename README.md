...
## About This Tutorial
This tutorial will teach you how to get plaintext passwords from an unlocked Password manager Chrome browser extension using memory analysis. The idea here is that this can be used as a payload for a RCE to get the passwords of a computer in use. 
